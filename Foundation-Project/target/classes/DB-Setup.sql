...
INSERT INTO Manager ("first name", "last name", email, username, "password") VALUES ('Veradis', 'Guerrea', 'vlewsey0@army.mil', 'vguerre0', 'FbmbqhHd1H');
INSERT INTO Manager ("first name", "last name", email, username, "password") VALUES ('Desdemona', 'Horlocke', 'dhorlock1@sphinn.com', 'dlowndsborough1', '7qlqT52iQz');
INSERT INTO Manager ("first name", "last name", email, username, "password") VALUES ('Nanon', 'Livingston', 'nglanders2@cnn.com', 'nkilvington2', 'KfCPsjxBP4Q');
